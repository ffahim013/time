  ...
  if (schedules.length === 0) {
    return (
      <div className="glass-panel rounded-[2rem] p-20 text-center border-dashed border-white/10 group">
        ...
        <h3 className="mono text-sm opacity-40 uppercase tracking-[0.3em]">Temporal Void Detected</h3>
        <p className="text-xs opacity-20 mt-2 font-light">No records found in current spatial coordinates.</p>
      </div>
    );
  }
